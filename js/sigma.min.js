...
// Initialize the sigma.js graph
var s = new sigma({
  container: 'sigma-container',
  // Your sigma.js configuration options
  // ...
});

// Add the clickNode event handler
s.bind('clickNode', function(e) {
  // Get the name of the clicked node
  var nodeName = e.data.node.label;

  // Construct the URL for the iframe
  var iframeSrc = 'https://aesthetics.fandom.com/wiki/' + nodeName;
