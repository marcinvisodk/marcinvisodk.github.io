...
this.bind('clickNode', function(event) {
  // Get the node that was clicked
  var node = event.data.node;

  // Construct the URL for the embedded website
  var url = 'https://aesthetics.fandom.com/wiki/' + node.label;

  // Get the embed element
  var embed = document.getElementById('embedded-website');

  // Set the src attribute to the website URL
...
(function() {
    if (!Array.prototype.some) Array.prototype.some = function(i, m) {
        ...
        for (var j = 0; j < f; j++)
            if (j in this && i.call(m, this[j], j, this)) return !0;
        return !1
    };
    ...
    if (!Object.keys) Object.keys = function() {
        ...
        return function(n) {
            ...
            if (m)
                for (r = 0; r < j; r++) i.call(n, f[r]) && u.push(f[r]);
            return u
        }
    }()
})();
...
(function() {
    ...
    function m() {
        ...
        this.addEdge = function(a, b, c, g) {
            ...
            if (!d.nodesIndex[c]) throw Error("Edge's target \"" +
        ...
        this.rescale = function(a, b, c, g) {
            ...
            var f = "outside" == d.p.scalingMode ?
                Math.max(a / Math.max(k - l, 1), b / Math.max(p - s, 1)) : Math.min(a / Math.max(k - l, 1), b / Math.max(p - s, 1)),
            ...
            var x, m;
            !d.p.maxEdgeSize && !d.p.minEdgeSize ? (x = 1, m = 0) : (x = d.p.maxEdgeSize == d.p.minEdgeSize ?
                0 : (d.p.maxEdgeSize - d.p.minEdgeSize) / o, m = d.p.minEdgeSize);
        ...
        this.setBorders = function() {
            ...
            d.nodes.forEach(function(a) {
                ...
                d.borders.maxY = Math.max(void 0 == d.borders.maxY ? a.displayY - a.displaySize : d.borders.maxY,
    ...
    function f(b, l) {
        function g() {
            var a;
            a = "<p>GLOBAL :</p>";
            for (var b in d.p.globalProbes) a += "<p>" + b + " : " +
                d.p.globalProbes[b]() + "</p>";
            a += "<br><p>LOCAL :</p>";
    ...
    function j(b) {
        ...
        function g(b, c, g) {
            if (!a.isMouseDown &&
                (window.clearInterval(a.interpolationID), w = void 0 != g, i = a.stageX, j = b, o = a.stageY, k = c, h = g || a.ratio, h = Math.min(Math.max(h, a.p.minRatio), a.p.maxRatio), m = a.p.directZooming ? 1 - (w ? a.p.zoomDelta : a.p.dragDelta) : 0, a.ratio != h || a.stageX != j || a.stageY != k)) d(), a.interpolationID = window.setInterval(d, 50), a.dispatch("startinterpolate")
        }
        ...
        function d() {
            ...
            var b = sigma.easing.quadratic.easeout(m),
                c = a.ratio;
            a.ratio = c * (1 - b) + h * b;
            w ? (a.stageX = j + (a.stageX - j) * a.ratio / c, a.stageY = k + (a.stageY -
                k) * a.ratio / c) : (a.stageX = i * (1 - b) + j * b, a.stageY = o * (1 - b) + k * b);
    ...
    function n(b, l, g, d, a, f, c) {
        function i(a) {
            ...
            b.fillStyle = "node" == h.p.labelHoverBGColor ? a.color ||
                h.p.defaultNodeColor : h.p.defaultHoverLabelBGColor;
            b.beginPath();
            ...
            b.shadowBlur = 0;
            b.beginPath();
            b.fillStyle = "node" == h.p.nodeBorderColor ? a.color ||
                h.p.defaultNodeColor : h.p.defaultNodeBorderColor;
            ...
            b.fillText(a.label, Math.round(a.displayX +
                1.5 * a.displaySize), Math.round(a.displayY + c / 2 - 3));
            return h
        }
            ...
            for (var b = a.nodes.length, c = 0; c++ < h.p.labelsSpeed && h.currentLabelIndex < b;)
                if (h.isOnScreen(a.nodes[h.currentLabelIndex])) {
                    var d = a.nodes[h.currentLabelIndex++],
                        l = g;
                    if (d.displaySize >= h.p.labelThreshold ||
                        d.forceLabel) {
        ...
        this.task_drawEdge = function() {
            for (var b = a.edges.length, c, d, g = 0; g++ < h.p.edgesSpeed && h.currentEdgeIndex < b;)
                if (e = a.edges[h.currentEdgeIndex],
                    c = e.source, d = e.target, e.hidden || c.hidden || d.hidden || !h.isOnScreen(c) && !h.isOnScreen(d)) h.currentEdgeIndex++;
                else {
        ...
        this.drawActiveNode = function(a) {
            ...
            b.beginPath();
            if (h.p.labelActiveShadow) b.shadowOffsetX =
                0, b.shadowOffsetY = 0, b.shadowBlur = 4, b.shadowColor = h.p.labelActiveShadowColor;
            sigma.tools.drawRoundRect(b, Math.round(a.displayX - c / 2 - 2), Math.round(a.displayY - c / 2 - 2), Math.round(b.measureText(a.label).width + 1.5 * a.displaySize + c / 2 + 4), Math.round(c + 4), Math.round(c / 2 + 2), "left");
            b.closePath();
            b.fill();
            b.shadowOffsetX = 0;
            ...
            b.arc(Math.round(a.displayX), Math.round(a.displayY),
                a.displaySize + h.p.borderSize, 0, 2 * Math.PI, !0);
            b.closePath();
            b.fill();
            b.beginPath();
    ...
    function u(b, l) {
        ...
        function d(a, b) {
            ...
            c.domElements[a].setAttribute("height",
                c.height + "px");
        ...
        d("monitor", "div");
        d("mouse", "canvas");
        this.plotter = new n(this.domElements.nodes.getContext("2d"), this.domElements.edges.getContext("2d"), this.domElements.labels.getContext("2d"), this.domElements.hover.getContext("2d"),
        ...
        this.draw = function(a, b, d, l) {
            ...
            if (a)
                ...
                else sigma.chronos.addTask(c.plotter.task_drawNode, "node_" + c.id, !1), l = !0, f = "node_" +
                    c.id;
            if (d)
                if (1 < d)
